...
function Home({ setIsAuth }) {
  ...
  const cardcontent = [
    {
      ...
      body: "With Language Learning Game, teachers can easily create interactive quizzes to assess their students' knowledge and engage them in an enjoyable learning experience. Whether you're a math whiz or a history buff, Language Learning Game has you covered with a wide range of quiz topics and customizable quiz settings to suit your teaching needs.",
    },
    {
      img: card2,
      title: "Easy-to-Use Quiz Creation",
      body: "Creating quizzes on Language Learning Game is a breeze. Our user-friendly quiz creation interface allows teachers to quickly create questions, add multiple-choice, true/false, or open-ended questions, set time limits, and customize scoring options. Teachers can also upload images or multimedia to make their quizzes more engaging and interactive.",
    },
    {
      img: card3,
      title: "Flexible Quiz Settings",
      body: "Language Learning Game offers flexible quiz settings that cater to various teaching styles. Teachers can choose to create timed or untimed quizzes, set pass marks, and customize feedback options for students. Quizzes can be shared with individual students or whole classes, and teachers can track their students' progress and performance in real-time.",
    },
    {
      img: card4,
      title: "Engage Your Students",
      body: "Language Learning Game makes learning fun and engaging for students. With its interactive quiz format and diverse question types, students can actively participate in the learning process and test their knowledge. They can receive immediate feedback on their performance, view their results, and review their answers to improve their understanding of the topic.",
    },
    {
      img: card5,
      title: "User-Friendly Student Interface",
      body: "Language Learning Game's student interface is designed to be user-friendly and intuitive. Students can easily access their assigned quizzes, view instructions, and submit their answers. They can also track their progress and view their scores to monitor their performance.",
    },
    {
      img: card6,
      title: "Track Progress in Real-Time",
      body: "Language Learning Game provides real-time tracking of students' progress and performance. Teachers can monitor students' quiz scores, view detailed reports, and identify areas for improvement. Students can track their own progress and strive for better results.",
    },
  ];
  ...
  return (
    <div className="text-center">
      ...
      >
        <div className="h1 py-4">Welcome to Language Learning Game</div>
        ...
        <div className="w-75 mt-4 mx-auto">
          Language Learning Game is a user-friendly quiz app that empowers teachers to create
          ...
          receive instant feedback, and track their progress. Join Language Learning Game today
      ...
      <div className="h1">About a Language Learning Game</div>
